# 
# = Capistrano initializers_secret_token_rb task
#
...
#
#   $ svn mv config/database.yml config/initializers/secret_token.example.yml
#   $ svn propset svn:ignore 'secret_token.rb' config/initializers
#
#   # Example for Git
#
#   $ git mv config/initializers/secret_token.rb config/initializers.secret_token.example.rb
...
# 
#   require "capistrano_initializers_secret_token_rb"
# 
  ...
  namespace :deploy do
    ...
    namespace :db do
      ...
      task :setup, :except => { :no_release => true } do
        ...
        put config.result(binding), "#{shared_path}/config/secret_token.rb"
      end
